 ...
 * make
 * .\waterwave_gestnerWaveWithLight.exe
 * 
 * */
#include <iostream>
#include <algorithm>
...
int main()
{
    ...
    Shader shader("../shader/GerstnerWave2.vs", "../shader/waterWithTexture.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //change the position of water surface relative to the sun
