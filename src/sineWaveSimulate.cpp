...
int main()
{
    ...
    Shader shader("../shader/SinWave.vs", "../shader/water.fs");
    ...
    int waveCount = 4;
    SineWave waves[10];
    setSineWaveData(shader, waveCount, waves);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.setVec3("deepWaterColor", glm::vec3(0.1f, 0.2f, 0.4f));
